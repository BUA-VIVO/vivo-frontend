...
<html lang="${country}">
	...
	<@lh.listBuaProjects />
	<@lh.listBuaMitglieder />
        <@lh.listExzellenzClusters />
    <script>
        var i18nStrings = {
	    ...
	    viewAllClusters: '${i18n().view_all_clusters?js_string}',
	    viewAllBuaMembers: '${i18n().view_all_buamembers?js_string}',
            noMembersFound: '${i18n().no_members_found?js_string}',
	    noClustersFound: '${i18n().no_clusters_found?js_string}',
	    noProjectsFound: '${i18n().no_projects_found?js_string}'
